    ...
    var DialogWindow,
        ...
        OverlayController = {
            init: function () {
                ...
                var overlays = ['widgets/brease/DialogWindow/DialogWindow', 'widgets/brease/MessageBox/MessageBox'];
                if (brease.config.mocked === true && brease.config.mockType !== 'project') {
                    overlays.push('widgets/brease/NumPad/NumPad', 'widgets/brease/KeyBoard/KeyBoard', 'widgets/brease/DateTimePicker/DateTimePicker');
                }

                fileManager.loadOverlays(overlays).done(function (DialogWindowClass, MessageBoxClass) {
