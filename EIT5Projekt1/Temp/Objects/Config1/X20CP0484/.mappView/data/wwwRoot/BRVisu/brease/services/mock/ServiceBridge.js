...
define(['brease/services/mock/Server', 'brease/controller/libs/VisuStatus', 'brease/controller/libs/ErrorCode'], function (Server, VisuStatus, ErrorCode) {
    /*jshint white:false*/
    'use strict';
    ...
    return {
        ...
        ************************/
        ...
        activateVisu: function (visuId, callback, callbackInfo) {
            ...
            if (data.visusWithoutLicense.indexOf(visuId) !== -1) {
        ...
        registerClient: function (callback) {
            var response = {
                "success": true,
                "ClientId": testServices.getModelData('client', 'id'),
                "status": {
