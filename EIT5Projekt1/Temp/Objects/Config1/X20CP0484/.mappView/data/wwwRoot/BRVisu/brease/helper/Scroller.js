...
define(['libs/iscroll-probe', 'brease/core/Utils'], function (IScroll, Utils) {
    ...
    */
    var Scroller = {
        ...
        init: function (popupManager) {
            Scroller.popupManager = popupManager;
        },
        ...
        */
        addScrollbars: function (selector, options, noObserver) {
            ...
            if (wrapper !== null) {
                ...
                if (Scroller.popupManager !== undefined && Scroller.popupManager.update !== undefined) {
                    Scroller.popupManager.update();
                }
                if (noObserver !== true) {
