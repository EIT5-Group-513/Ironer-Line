...
define(['brease/controller/libs/Client', 'brease/core/Utils', 'brease/events/BreaseEvent', 'brease/controller/libs/LogCode', 'brease/helper/Scroller', 'brease/controller/PopUpManager', 'brease/helper/Messenger', 'brease/helper/SystemMessage', 'brease/config', 'brease/settings'], function (Client, Utils, BreaseEvent, LogCode, Scroller, popupManager, Messenger, systemMessage, config, settings) {
    ...
    */
    ...
    function _start() {
        ...
        _runtimeService.registerClient(_registerClientResponse, config.visuId);
    }
    ...
    function _initControllers(runtimeService, settings, systemMessage) {
        ...
        _controller.bindingController.init(runtimeService, settings);
        _controller.connectionController.init(runtimeService, systemMessage);
        _controller.infoController.init(runtimeService);
        _controller.clientSystemEvents.init(runtimeService, _controller.bindingController);
        this.action.init(runtimeService);
        this.pageController.init(runtimeService);
        this.uiController.init(settings, _controller.bindingController, _controller.widgetsController);
    }
    ...
    function _startSocket() {
        ...
        _runtimeService.addEventListener(BreaseEvent.SESSION_ACTIVATED, _sessionActivatedHandler);
        $.when(
